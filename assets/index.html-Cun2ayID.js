import{_ as n,c as a,d as l,o as i}from"./app-Dy69Q1eD.js";const p={};function e(c,s){return i(),a("div",null,s[0]||(s[0]=[l(`<p>在 JavaScript 中，async/await 是处理异步操作的强大工具，但它经常让人困惑：它到底是同步还是异步？本文将通过直观的示例来澄清这个概念，深入解析其特性。</p><h2 id="核心结论" tabindex="-1"><a class="header-anchor" href="#核心结论"><span>核心结论</span></a></h2><p><strong>async/await 本质上是异步的，但提供了同步风格的代码结构</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>// async/await 的异步本质</span></span>
